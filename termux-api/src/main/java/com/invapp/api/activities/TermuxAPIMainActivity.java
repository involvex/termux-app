package com.invapp.api.activities;
...
import com.invapp.api.TermuxAPIApplication;
import com.invapp.api.settings.activities.TermuxAPISettingsActivity;
import com.invapp.api.util.ViewUtils;
...
public class TermuxAPIMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatActivityUtils.setToolbarTitle(this, com.invapp.shared.R.id.toolbar, TermuxConstants.TERMUX_API_APP_NAME, 0);
    ...
    private void setChangeLauncherActivityStateViews() {
        ...
        if (currentlyDisabled) {
            ...
            stateChangeMessage = getString(com.invapp.shared.R.string.msg_enabling_launcher_icon, TermuxConstants.TERMUX_API_APP_NAME);
            newState = true;
        } else {
            changeLauncherActivityStateButton.setText(com.invapp.shared.R.string.action_disable_launcher_icon);
            stateChangeMessage = getString(com.invapp.shared.R.string.msg_disabling_launcher_icon, TermuxConstants.TERMUX_API_APP_NAME);
            newState = false;
        }
