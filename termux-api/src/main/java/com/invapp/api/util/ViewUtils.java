...
import com.invapp.shared.theme.ThemeUtils;
...
public class ViewUtils {
    ...
    public static void setWarningTextViewAndButtonState(@NonNull Context context,
        ...
        if (warningState) {
            textView.setTextColor(ContextCompat.getColor(context, com.invapp.shared.R.color.red_error));
            textView.setLinkTextColor(ContextCompat.getColor(context, com.invapp.shared.R.color.red_error_link));
