package com.invapp.app.terminal;
...
import com.invapp.shared.interact.MessageDialogUtils;
...
import com.invapp.shared.termux.extrakeys.SpecialButton;
...
import com.invapp.app.models.UserAction;
import com.invapp.app.terminal.io.KeyboardShortcut;
...
import com.invapp.shared.termux.data.TermuxUrlUtils;
...
public class TermuxTerminalViewClient extends TermuxTerminalViewClientBase {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent e, TerminalSession currentSession) {
        ...
        if (keyCode == KeyEvent.KEYCODE_ENTER && !currentSession.isRunning()) {
            ...
            if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN || unicodeChar == 'n'/* next */) {
                ...
                mActivity.showTerminalActionsSheet();
    ...
    public void reportIssueFromTranscript() {
        ...
        MessageDialogUtils.showMessage(mActivity, TermuxConstants.TERMUX_APP_NAME + " Report Issue",
            ...
            mActivity.getString(com.invapp.shared.R.string.action_yes), (dialog, which) -> reportIssueFromTranscript(transcriptText, true),
            mActivity.getString(com.invapp.shared.R.string.action_no), (dialog, which) -> reportIssueFromTranscript(transcriptText, false),
            null);
    }
