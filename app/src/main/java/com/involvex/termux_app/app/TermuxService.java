...
import com.involvex.termux_app.app.event.SystemEventReceiver;
import com.involvex.termux_app.app.terminal.TermuxTerminalSessionActivityClient;
import com.involvex.termux_app.app.terminal.TermuxTerminalSessionServiceClient;
import com.involvex.termux_app.shared.termux.plugins.TermuxPluginUtils;
import com.involvex.termux_app.shared.data.IntentUtils;
import com.involvex.termux_app.shared.net.uri.UriUtils;
import com.involvex.termux_app.shared.errors.Errno;
import com.involvex.termux_app.shared.shell.ShellUtils;
import com.involvex.termux_app.shared.shell.command.runner.app.AppShell;
import com.involvex.termux_app.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.involvex.termux_app.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.involvex.termux_app.shared.termux.shell.TermuxShellUtils;
...
import com.involvex.termux_app.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.involvex.termux_app.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.involvex.termux_app.shared.termux.shell.TermuxShellManager;
...
import com.involvex.termux_app.shared.notification.NotificationUtils;
...
import com.involvex.termux_app.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.involvex.termux_app.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.involvex.termux_app.shared.R.string.error_execution_cancelled))) {
