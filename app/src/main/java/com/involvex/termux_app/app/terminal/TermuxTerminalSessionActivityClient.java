...
import com.involvex.termux_app.shared.termux.terminal.io.BellHandler;
import com.involvex.termux_app.shared.logger.Logger;
import com.involvex.termux_app.terminal.TerminalColors;
import com.involvex.termux_app.terminal.TerminalSession;
import com.involvex.termux_app.terminal.TerminalSessionClient;
import com.involvex.termux_app.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.involvex.termux_app.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.involvex.termux_app/com.involvex.termux_app.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
