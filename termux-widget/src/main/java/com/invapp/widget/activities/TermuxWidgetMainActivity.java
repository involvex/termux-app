package com.invapp.widget.activities;
...
import com.invapp.shared.markdown.MarkdownUtils;
import com.invapp.shared.termux.TermuxConstants;
import com.invapp.shared.termux.file.TermuxFileUtils;
import com.invapp.shared.theme.NightMode;
import com.invapp.widget.R;
import com.invapp.widget.ShortcutFile;
import com.invapp.widget.TermuxWidgetApplication;
import com.invapp.widget.TermuxWidgetProvider;
import com.invapp.widget.utils.ShortcutUtils;
...
public class TermuxWidgetMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatActivityUtils.setToolbarTitle(this, com.invapp.shared.R.id.toolbar, TermuxConstants.TERMUX_WIDGET_APP_NAME, 0);
    ...
    private void setChangeLauncherActivityStateViews() {
        ...
        if (currentlyDisabled == null) {
            ...
            changeLauncherActivityStateButton.setText(com.invapp.shared.R.string.action_disable_launcher_icon);
        ...
        if (currentlyDisabled) {
            changeLauncherActivityStateButton.setText(com.invapp.shared.R.string.action_enable_launcher_icon);
            stateChangeMessage = getString(com.invapp.shared.R.string.msg_enabling_launcher_icon, TermuxConstants.TERMUX_WIDGET_APP_NAME);
            newState = true;
        } else {
            changeLauncherActivityStateButton.setText(com.invapp.shared.R.string.action_disable_launcher_icon);
            stateChangeMessage = getString(com.invapp.shared.R.string.msg_disabling_launcher_icon, TermuxConstants.TERMUX_WIDGET_APP_NAME);
            newState = false;
        }
