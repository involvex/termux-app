package com.involvex.termux_app.shared.activities;
...
import com.involvex.termux_app.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.involvex.termux_app.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.involvex.termux_app.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
