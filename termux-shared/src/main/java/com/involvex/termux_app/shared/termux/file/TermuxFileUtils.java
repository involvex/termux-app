package com.involvex.termux_app.shared.termux.file;
...
import com.involvex.termux_app.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.involvex.termux_app` as secondary user will result
     * in `ls: /data/user/0/com.involvex.termux_app: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.involvex.termux_app` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.involvex.termux_app` where `10` is
