...
import com.involvex.termux_app.shared.reflection.ReflectionUtils;
...
import com.involvex.termux_app.shared.android.PackageUtils;
import com.involvex.termux_app.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.involvex.termux_app`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.involvex.termux_app/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.involvex.termux_app" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.involvex.termux_app.shared.R.raw.apt_info_script);
        try {
